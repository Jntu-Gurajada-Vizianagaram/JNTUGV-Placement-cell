    ...
    if pdf_file is not None:
        ...
        if resume_data:
            ...
            if 'Projects' in resume_text:
                ...
                st.markdown('<h5 class="tip-text">[-] Please add more detailed Projects. It will show that you have done work related the required position or not.</h5>',unsafe_allow_html=True)
            ...
            if resume_sentiment == "Positive":
                st.success("Your resume has a positive sentiment. Great job! Here are some additional points:")
                ...
                st.info("Your resume sentiment is neutral. Consider these points:")
                ...
                st.error("Your resume has a negative sentiment. Here are some points to improve:")
